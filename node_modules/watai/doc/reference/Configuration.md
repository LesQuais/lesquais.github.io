...
For backwards compatibility, a second parameter has to be used to trigger the usage of a promise. This parameter does not have any meaning (it is always `true`), and will be removed in v0.7.
